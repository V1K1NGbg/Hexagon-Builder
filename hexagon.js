...
HexagonGrid.prototype.drawHexAtColRow = function (
    ...
    if (bcolor == "black") {
        ...
        this.drawHexAtColRow(column, row + 1, "", "blue");
        this.drawHexAtColRow(column + 1, row, "", "blue");
        this.drawHexAtColRow(column - 1, row, "", "blue");
        if (Math.abs(column + Math.round(window.innerWidth / 160)) % 2) {
            this.drawHexAtColRow(column + 1, row + 1, "", "blue");
            this.drawHexAtColRow(column - 1, row + 1, "", "blue");
        } else {
            this.drawHexAtColRow(column + 1, row - 1, "", "blue");
            this.drawHexAtColRow(column - 1, row - 1, "", "blue");
    ...
    this.drawHex(drawx, drawy, color, bcolor);
};

HexagonGrid.prototype.drawHex = function (x0, y0, fillColor, sideColor) {
    this.context.strokeStyle = sideColor;
...
HexagonGrid.prototype.isPointInTriangle = function isPointInTriangle(
    pt,
    v1,
    v2,
    v3
